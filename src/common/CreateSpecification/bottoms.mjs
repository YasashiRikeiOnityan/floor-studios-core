...
export const bottomsSpecification = async (specification, tenantId) => {
    ...
    try {
        ...
        const informationContent = await safeEvaluate(async (spec) => {
            ...
            const shippingCompanyName = document.querySelector('[data-layer="shipping_sample_production_company_name"]');
            shippingCompanyName.textContent = spec.information?.shipping_information_sample?.company_name || "";
            const shippingName = document.querySelector('[data-layer="shipping_sample_production_name"]');
            shippingName.textContent = (spec.information?.shipping_information_sample?.first_name || "") + (spec.information?.shipping_information_sample?.first_name && spec.information?.shipping_information_sample?.last_name ? " " : "") + (spec.information?.shipping_information_sample?.last_name || "");
            const shippingPhoneNumber = document.querySelector('[data-layer="shipping_sample_production_phone_number"]');
            shippingPhoneNumber.textContent = spec.information?.shipping_information_sample?.phone_number || "";
            const shippingEmail = document.querySelector('[data-layer="shipping_sample_production_email"]');
            shippingEmail.textContent = spec.information?.shipping_information_sample?.email || "";
            const shippingZipCode = document.querySelector('[data-layer="shipping_sample_production_zip_code"]');
            shippingZipCode.textContent = spec.information?.shipping_information_sample?.zip_code || "";
            const shippingAddressLine2 = document.querySelector('[data-layer="shipping_sample_production_address_line_2"]');
            shippingAddressLine2.textContent = spec.information?.shipping_information_sample?.address_line_2 || "";
            const shippingAddressLine1 = document.querySelector('[data-layer="shipping_sample_production_address_line_1"]');
            shippingAddressLine1.textContent = spec.information?.shipping_information_sample?.address_line_1 || "";
            const shippingCity = document.querySelector('[data-layer="shipping_sample_production_city"]');
            shippingCity.textContent = spec.information?.shipping_information_sample?.city || "";
            const shippingState = document.querySelector('[data-layer="shipping_sample_production_state"]');
            shippingState.textContent = spec.information?.shipping_information_sample?.state || "";
            const shippingCountry = document.querySelector('[data-layer="shipping_sample_production_country"]');
            shippingCountry.textContent = spec.information?.shipping_information_sample?.country || "";
            const shippingMainProductionCompanyName = document.querySelector('[data-layer="shipping_mass_production_company_name"]');
            shippingMainProductionCompanyName.textContent = spec.information?.shipping_information_main_production?.company_name || "";
            const shippingMainProductionName = document.querySelector('[data-layer="shipping_mass_production_name"]');
            shippingMainProductionName.textContent = (spec.information?.shipping_information_main_production?.first_name || "") + (spec.information?.shipping_information_main_production?.first_name && spec.information?.shipping_information_main_production?.last_name ? " " : "") + (spec.information?.shipping_information_main_production?.last_name || "");
            const shippingMainProductionPhoneNumber = document.querySelector('[data-layer="shipping_mass_production_phone_number"]');
            shippingMainProductionPhoneNumber.textContent = spec.information?.shipping_information_main_production?.phone_number || "";
            const shippingMainProductionEmail = document.querySelector('[data-layer="shipping_mass_production_email"]');
            shippingMainProductionEmail.textContent = spec.information?.shipping_information_main_production?.email || "";
            const shippingMainProductionZipCode = document.querySelector('[data-layer="shipping_mass_production_zip_code"]');
            shippingMainProductionZipCode.textContent = spec.information?.shipping_information_main_production?.zip_code || "";
            const shippingMainProductionAddressLine2 = document.querySelector('[data-layer="shipping_mass_production_address_line_2"]');
            shippingMainProductionAddressLine2.textContent = spec.information?.shipping_information_main_production?.address_line_2 || "";
            const shippingMainProductionAddressLine1 = document.querySelector('[data-layer="shipping_mass_production_address_line_1"]');
            shippingMainProductionAddressLine1.textContent = spec.information?.shipping_information_main_production?.address_line_1 || "";
            const shippingMainProductionCity = document.querySelector('[data-layer="shipping_mass_production_city"]');
            shippingMainProductionCity.textContent = spec.information?.shipping_information_main_production?.city || "";
            const shippingMainProductionState = document.querySelector('[data-layer="shipping_mass_production_state"]');
            shippingMainProductionState.textContent = spec.information?.shipping_information_main_production?.state || "";
            const shippingMainProductionCountry = document.querySelector('[data-layer="shipping_mass_production_country"]');
            shippingMainProductionCountry.textContent = spec.information?.shipping_information_main_production?.country || "";
